...
namespace BibliotecaFerreteria
{
    public class Accesorios:Producto
    {
        ...
        public Accesorios(Usuario usuario, Ambito ambito)
        {
        ...
        ///protected int stock;
        /// </summary>
        public Accesorios(Usuario usuario, Ambito ambito,string tipoDeProducto,string nombreProducto ,
        ...
        public Accesorios(int idProducto, string nombre, double precio, int cantidad, double iva,
        ...
        {
            return this.precioDeProducto * 0.13;
        }
